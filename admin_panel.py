    ...
    if admin_mode == "Impersonate Teacher":
        ...
        if "impersonated_teacher" in st.session_state:
            ...
            if teacher_action == "View My Courses":
                ...
                search_query = st.text_input("Search Your Courses", placeholder="Enter keyword...", key="teacher_search")
                ...
                if display_courses:
                    for course in display_courses:
                        ...
                        with st.container():
                            ...
                            st.markdown(f"**Subject:** {subject} | **Grade:** {grade} | **Max Students:** {max_students} | **Enrolled:** {num_enrolled}")
            ...
            if filtered_teachers:
                for teacher in filtered_teachers:
                    ...
                    with st.container():
                        ...
                        st.markdown(f"**Description:** {t_desc if t_desc else 'No description available.'}")
